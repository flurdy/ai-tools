...
- [`pi-permission-system.config.example.json`](pi-permission-system.config.example.json) — conservative policy proposed by the [20.9.0 audit](pi-permission-system-audit.md); the package remains deferred and is not in the settings starter.
- [`pi-permission-system-audit.md`](pi-permission-system-audit.md) — bounded security review and pilot constraints for the pinned package version.

None of the JSON examples contains credentials, account identifiers, local history, or generated state.
